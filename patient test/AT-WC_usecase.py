...
data = pd.read_csv(r"C:\Users\Arav\OneDrive\Desktop\Aarav File\universal informatuc\ATpatients.csv")
data2 = pd.read_csv(r"C:\Users\Arav\OneDrive\Desktop\Aarav File\universal informatuc\waist.csv")
...
with engine.connect() as con:
    con.execute('ALTER TABLE `atpatients` ADD PRIMARY KEY (`Patient`);')
    
with engine.connect() as con:
    con.execute('ALTER TABLE `waist` ADD PRIMARY KEY (`Patient`);')
...
# ############ optional ###############
wcat = pd.read_csv(r"C:/Users/360digiTMG/Desktop/simple linear flask_v1/datasets/wc-at.csv")
...
wcat_test = pd.read_csv(r"C:/360digiTMG/Desktop/simple linear flask_v1/datasets/wc-at_test.csv")
