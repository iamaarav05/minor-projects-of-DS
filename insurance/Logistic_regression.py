...
claims = pd.read_csv(r"C:\Users\Arav\Downloads\New folder (2)\claims_test.xlsx").convert_dtypes()
claims.info()
...
y_pred_train = logisticmodel.predict(y_test)  
y_pred_train
...
# Load the new data
data = pd.read_excel(r"C:\Users\asus\DataScience\codes_DS_sample\Regression Analysis\Logistic Regression\logistic regresssion\claims_test.xlsx").convert_dtypes()
